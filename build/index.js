...
function Pagination(_a) {
    ...
    return React__default.createElement("div", { className: "patterns-data-table-pagination" },
        React__default.createElement(core.ButtonGroup, null,
            React__default.createElement(core.Button, { disabled: page === 1, minimal: true, onClick: function () { return onChange(1, size); } }, "Prv\u00E1"),
            ...
            React__default.createElement(core.Button, { disabled: page === totalPages, minimal: true, onClick: function () { return onChange(totalPages, size); } }, "Posledn\u00E1"),
            React__default.createElement(PageSizeSelect, { items: PageSizes, itemRenderer: function (item, options) { return React__default.createElement(core.MenuItem, { key: "pagination-item-" + item.value, text: item.title, onClick: options.handleClick }); }, onItemSelect: function (item) { return onChange(page, item.value); } },
                React__default.createElement(core.Button, { minimal: true, rightIcon: "chevron-down", text: size + " na stranu", style: { margin: 0 }, className: "low-button" }))));
}

// export const Container = <div className="patterns-data-table"/>
var Container = function (_a) {
    var children = _a.children, style = _a.style;
    return React__default.createElement('div', { className: 'patterns-data-table', style: style }, children);
};
var FlexRow = function (_a) {
    var children = _a.children, flex = _a.flex, style = _a.style;
    return React__default.createElement('div', { className: 'patterns-flex-row', style: __assign(__assign({}, style), { flex: flex }) }, children);
};
var FlexColumn = function (_a) {
    var children = _a.children, flex = _a.flex, style = _a.style;
    return React__default.createElement('div', { className: 'patterns-flex-column', style: __assign(__assign({}, style), { flex: flex }) }, children);
};
var Toolbar = function (_a) {
    var children = _a.children;
    return React__default.createElement('div', { className: 'patterns-toolbar' }, children);
};
var Header = function (_a) {
    var children = _a.children;
    return React__default.createElement('div', { className: 'patterns-data-table-header' }, children);
};
var Content = function (_a) {
    var children = _a.children;
    return React__default.createElement('div', { className: 'patterns-data-table-content' }, children);
};
var ItemRow = function (_a) {
    var children = _a.children;
    return React__default.createElement('div', { className: 'patterns-data-table-item-row' }, children);
};
var ExpandedItemRow = function (_a) {
    var children = _a.children;
    return React__default.createElement('div', { className: 'patterns-data-table-item-row-expanded' }, children);
};
var SelectionCount = function (_a) {
    var children = _a.children;
    return React__default.createElement('div', { className: 'patterns-data-table-selection-count' }, children);
};
        ...
        React__default.createElement(FlexColumn, { flex: 1 },
            React__default.createElement(FlexRow, { style: { height: 30, justifyContent: 'center' } },
                React__default.createElement(core.FormGroup, { style: { marginRight: 12 } },
                    React__default.createElement(core.InputGroup, { placeholder: "Filter...", value: this.state.filterStates[column.id].value || '', onChange: function (evt) { return setFilterValue(column, evt.currentTarget.value); } })),
            ...
            React__default.createElement(FlexRow, { style: { fontSize: 12, justifyContent: 'start', paddingTop: 6, paddingLeft: 6, marginTop: 6 } },
                React__default.createElement(core.RadioGroup, { selectedValue: this.state.filterStates[column.id].comparator, onChange: function (evt) { return setFilterComparator(column, evt.currentTarget.value); } },
                    React__default.createElement(core.Radio, { label: "Obsahuje", value: "contains" }),
                    React__default.createElement(core.Radio, { label: "Za\u010D\u00EDna na", value: "starts_with" }),
                    React__default.createElement(core.Radio, { label: "Kon\u010D\u00ED na", value: "ends_with" })))));
}
        ...
        React__default.createElement(FlexColumn, { flex: 1 },
            React__default.createElement(FlexRow, { style: { height: 30, justifyContent: 'center' } },
                React__default.createElement(core.ControlGroup, null,
                    React__default.createElement(core.FormGroup, { style: { marginRight: 12 } },
                        React__default.createElement(core.InputGroup, { placeholder: this.state.filterStates[column.id].comparator === 'range' ? 'Od...' : 'Hodnota', value: getValue(false), onChange: function (evt) { return setFilterValue(column, parseFloat(evt.currentTarget.value)); } })),
                    this.state.filterStates[column.id].comparator === 'range' &&
                        React__default.createElement(core.FormGroup, null,
                            React__default.createElement(core.InputGroup, { placeholder: "Do...", value: getValue(true), onChange: function (evt) { return setFilterValue(column, parseFloat(evt.currentTarget.value), true); } }))),
                React__default.createElement(core.Button, { minimal: true, intent: core.Intent.DANGER, className: core.Classes.POPOVER_DISMISS, onClick: function (evt) { return setFilterActive(column, false); }, icon: "cross" }),
                React__default.createElement(core.Button, { minimal: true, intent: core.Intent.SUCCESS, className: core.Classes.POPOVER_DISMISS, onClick: function (evt) { return setFilterActive(column, true); }, icon: "tick" })),
            React__default.createElement(FlexRow, { style: { fontSize: 12, justifyContent: 'start', paddingTop: 6, paddingLeft: 6, marginTop: 6 } },
                React__default.createElement(core.RadioGroup, { selectedValue: this.state.filterStates[column.id].comparator, onChange: function (evt) { return setFilterComparator(column, evt.currentTarget.value); } },
                    React__default.createElement(core.Radio, { label: "Rovn\u00E9", value: "eq" }),
                    React__default.createElement(core.Radio, { label: "Men\u0161ie ako", value: "lte" }),
                    React__default.createElement(core.Radio, { label: "V\u00E4\u010D\u0161ie ako", value: "gte" }),
                    React__default.createElement(core.Radio, { label: "Rozsah", value: "range" })))));
}
