...
export declare const Container: ({ children, style }: React.PropsWithChildren<Props>) => React.DetailedReactHTMLElement<{
    className: string;
    style: React.CSSProperties;
}, HTMLElement>;
...
export declare const Cell: ({ children, width, flex, head, onClick, className, alignment }: React.PropsWithChildren<CellProps>) => React.DetailedReactHTMLElement<{
    className: string;
    style: React.CSSProperties;
    onClick: () => void;
}, HTMLElement>;
export declare const Filter: ({ children }: {
    children: any;
