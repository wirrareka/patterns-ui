...
export default function InvoiceItemView(_a) {
    ...
    return React.createElement(ItemDocumentItemRow, { key: "invoice-item-" + item.index },
        React.createElement(Row, { flex: 4, style: { textAlign: 'left', fontSize: 14 } },
        ...
        showVat &&
            React.createElement(React.Fragment, null,
                React.createElement(Row, __assign({}, rightRowProps, { flex: 1 }),
