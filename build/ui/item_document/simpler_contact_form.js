    ...
    ContactForm.prototype.render = function () {
        ...
        return React.createElement(AddressBoxContainer, null,
            ...
            React.createElement(AddressBoxOther, null,
                ...
                React.createElement(Row, { style: { height: 26 } },
                    React.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.phone, onChange: function (evt) { return _this.props.onChange('phone', evt.currentTarget.value); }, placeholder: t('phone') }))),
            this.props.detail && this.props.detail);
    };
    return ContactForm;
}(React.Component));
export default ContactForm;
//# sourceMappingURL=simpler_contact_form.js.map