            ...
            React.createElement(Page, null,
                React.createElement(Header, null,
                    ...
                    React.createElement(Column, { style: { flex: 1 } },
                        React.createElement(HeaderCode, null, this.props.document.code || t('order.new')),
                ...
                React.createElement(OrderItemsView, { showVat: PatternApp.settings.orders.showVat, document: this.props.document, onChange: function (items) { return _this.props.onChange('items', items); } }),
