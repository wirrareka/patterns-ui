...
var InvoiceView = /** @class */ (function (_super) {
    ...
    InvoiceView.prototype.renderTotal = function (currency) {
        return React.createElement(Row, { flex: 1, style: { height: 42, alignItems: 'center' } },
            ...
            React.createElement(Column, { flex: 7, className: "patterns-item-document-total" }, PatternApp.format.price(PatternApp.settings.invoices.showVat ? this.props.document.itemsTotalWithVat : this.props.document.itemsTotal, currency)));
    };
    InvoiceView.prototype.render = function () {
        ...
        return React.createElement(Wrapper, null,
            React.createElement(Page, { style: { padding: '12mm' } },
                React.createElement(Header, null,
                    ...
                    React.createElement(Column, { flex: 4, style: { flex: 4 } },
                        React.createElement(HeaderCode, null,
                            React.createElement(InputGroup, { fill: true, disabled: true, defaultValue: this.props.document.code, 
                        ...
                        React.createElement(Column, { flex: 1 },
                            ...
                            paymentMethod.code === PaymentMethod.bankTransfer.code &&
                                React.createElement(React.Fragment, null,
                                    ...
                                    PatternApp.settings.invoices.showSymbols && React.createElement(React.Fragment, null,
                ...
                React.createElement(InvoiceItemsView, { editableCode: this.props.editableCode, showVat: PatternApp.settings.invoices.showVat, document: this.props.document, onChange: function (items) { return _this.props.onChange('items', items); } }),
