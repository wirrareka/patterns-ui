...
export declare const InvoiceItemRow: ({ children, style }: React.PropsWithChildren<Props>) => React.DetailedReactHTMLElement<{
    className: string;
    style: React.CSSProperties;
}, HTMLElement>;
export declare const InvoiceCurrency: ({ children, style }: React.PropsWithChildren<Props>) => React.DetailedReactHTMLElement<{
    className: string;
    style: React.CSSProperties;
}, HTMLElement>;
export declare const InvoiceTableHeader: ({ children, style, align }: React.PropsWithChildren<AlignProps>) => React.DetailedReactHTMLElement<{
    className: string;
    style: {
...
export declare const InvoiceItemsHeaderRow: ({ children, style, flex }: React.PropsWithChildren<FlexProps>) => React.DetailedReactHTMLElement<{
    className: string;
    style: {
        flex: number;
        alignContent?: string;
...
export declare const InvoiceItemsContainer: ({ children, style }: React.PropsWithChildren<Props>) => React.DetailedReactHTMLElement<{
    className: string;
    style: React.CSSProperties;
}, HTMLElement>;
