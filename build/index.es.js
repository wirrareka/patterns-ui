...
import { ButtonGroup, Button, Colors, MenuItem, Checkbox, Popover, PopoverInteractionKind, PopoverPosition, Icon, FormGroup, InputGroup, Intent, Classes, RadioGroup, Radio, ControlGroup, Tag, Tooltip, NumericInput, EditableText, TextArea } from '@blueprintjs/core';
    ...
    return React__default.createElement(FlexColumn, { flex: 1 },
        React__default.createElement(ItemDocumentItemRow, { key: "invoice-item-" + item.index },
            ...
            React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 3 }),
                React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right", placeholder: t('edit'), value: item.price, onValueChange: onPriceChange }),
            ...
            React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 3 }),
                React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right", placeholder: t('edit'), value: item.linePrice, onValueChange: onLinePriceChange }),
                React__default.createElement(ItemDocumentCurrency, null, currency.symbol)),
            showVat &&
                React__default.createElement(React__default.Fragment, null,
                    React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                        React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right", placeholder: t('edit'), value: item.vat, onValueChange: onVatChange }),
                        React__default.createElement(ItemDocumentCurrency, null, "%")),
                    React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                        React__default.createElement(EditableText, { disabled: true, className: "align-right", placeholder: t('edit'), value: "" + instance.settings.format.price(item.vatPrice) }),
                        React__default.createElement(ItemDocumentCurrency, null, currency.symbol)),
                    React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 3 }),
                        React__default.createElement(EditableText, { disabled: true, className: "align-right", placeholder: t('edit'), value: "" + instance.settings.format.price(item.linePriceWithVat) }),
                        React__default.createElement(ItemDocumentCurrency, null, currency.symbol)))),
...
var ContactForm = /** @class */ (function (_super) {
    ...
    ContactForm.prototype.renderSuggestItem = function (contact, options) {
        return React__default.createElement(MenuItem, { key: "contact-" + this.props.contact.id, text: this.props.contact.name.length > 0 ? contact.name : contact.fullName, onClick: options.handleClick });
    };
    ContactForm.prototype.renderSuggest = function () {
        var _this = this;
        return React__default.createElement(FlexRow, null,
            React__default.createElement(ContactSuggest, { fill: true, className: "suggest-minimal patterns-contact-form-suggest", items: this.state.results, inputValueRenderer: function (contact) { return contact.name || contact.fullName; }, itemRenderer: this.renderSuggestItem, onItemSelect: this.props.onReplace, query: this.state.query, selectedItem: this.props.contact, onQueryChange: function (query) { return _this.props.onChange('name', query); }, noResults: React__default.createElement(MenuItem, { icon: "plus", text: "Nov\u00FD klient" }) }),
...
export { Alignment, BaseModel, ColumnType, Contact, Container, Currency, DataTable, DocumentItem, FlexColumn, FlexRow, Invoice, ItemDocument, localeManager as LocaleManager, Order, OrderView, instance as PatternApp, PaymentMethod, PriceQuote, Return, Toolbar };
