...
import { Dialog, Classes, NonIdealState, Button, ButtonGroup, Colors, MenuItem, Checkbox, Popover, PopoverInteractionKind, PopoverPosition, Icon, FormGroup, InputGroup, Intent, RadioGroup, Radio, ControlGroup, Tag, Tooltip, Toaster, Position, ProgressBar, NumericInput, EditableText, TextArea } from '@blueprintjs/core';
import { Select, Suggest } from '@blueprintjs/select';
import { DateInput } from '@blueprintjs/datetime';
import { StyleSheet, View, Text, Document, Font, Image, Page as Page$1 } from '@react-pdf/renderer';
...
var jsBigDecimal = createCommonjsModule(function (module, exports) {
...
var bigDecimal = unwrapExports(jsBigDecimal);
...
var Confirm = /** @class */ (function (_super) {
    ...
    Confirm.prototype.render = function () {
        var _this = this;
        return React__default.createElement(Dialog, { isOpen: this.state.isOpen, onClose: function () { return _this.setState({ isOpen: false }); } },
            React__default.createElement("div", { className: Classes.DIALOG_BODY },
                React__default.createElement(NonIdealState, { icon: this.state.icon, title: this.state.title, description: this.state.description, action: React__default.createElement(FlexRow, null,
                        React__default.createElement(Button, { icon: "cross", text: t('cancel'), minimal: true, style: { marginRight: 12 }, onClick: function () { return _this.setState({ isOpen: false }); } }),
                        React__default.createElement("div", { onClick: function (evt) { return _this.setState({ isOpen: false }); } }, this.state.action)) })));
    };
    return Confirm;
...
var ColumnPicker = /** @class */ (function (_super) {
    ...
    ColumnPicker.prototype.renderColumns = function () {
        var _this = this;
        return this.props.columns.map(function (column) { return createElement(Checkbox, { key: "datatable-column-picker-checkbox-" + column.id, label: column.title, checked: column.visible || false, onChange: function (evt) {
    ...
    ColumnPicker.prototype.render = function () {
        return createElement(Popover, { interactionKind: PopoverInteractionKind.CLICK, position: PopoverPosition.BOTTOM_RIGHT },
            ...
            createElement("div", { className: "patterns-data-table-column-picker" },
...
var DataTable = /** @class */ (function (_super) {
    ...
    DataTable.prototype.formatSelection = function () {
        ...
        if (count === 0) {
            ...
            return React__default.createElement(SelectionCount, null,
                t('selection_one'),
                " ",
                React__default.createElement(Tag, { round: true, minimal: true, intent: "primary" },
    ...
    DataTable.prototype.renderEmptyCell = function (column, index) {
        ...
        return React__default.createElement(Cell, { className: Classes.SKELETON, flex: column.flex, width: column.width, key: key }, "\u00A0");
    };
        ...
        return this.state.items.map(function (item, index) {
            ...
            if (_this.props.multiple) {
                cells.splice(0, 0, React__default.createElement(Cell, { width: 30, key: "datatable-row-selection-" + index },
                    React__default.createElement(Checkbox, { style: { justifySelf: 'center', alignSelf: 'center', marginBottom: 0 }, className: "datatable-item-selector", checked: _this.state.selection[_item.id], onChange: function (evt) { return __awaiter(_this, void 0, void 0, function () {
                            var selection;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
            ...
            if (_this.props.expandable) {
                cells.splice(0, 0, React__default.createElement(Cell, { width: 36, key: "datatable-row-expand-" + index },
                    React__default.createElement(Button, { minimal: true, icon: React__default.createElement(Icon, { color: _this.isExpanded(item) ? Colors.RED1 : Colors.GRAY5, icon: _this.isExpanded(item) ? 'chevron-down' : 'chevron-right' }), style: { justifySelf: 'center', alignSelf: 'center', marginBottom: 0 }, onClick: function (evt) { return __awaiter(_this, void 0, void 0, function () {
                            var expanded;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
    ...
    DataTable.prototype.renderHeader = function () {
        ...
        if (this.props.multiple) {
            cells.splice(0, 0, React__default.createElement(Cell, { width: 30, key: "datatable-header-selection" },
                React__default.createElement(Tooltip, { interactionKind: PopoverInteractionKind.HOVER, position: PopoverPosition.RIGHT },
                    React__default.createElement(Checkbox, { checked: this.getSelectedIds().length === this.state.items.length, onChange: this.selectAll, style: { justifySelf: 'center', alignSelf: 'center', marginBottom: 0 } }),
                    "Ozna\u010Di\u0165 v\u0161etky")));
        }
        ...
        return React__default.createElement(Container, null,
            ...
            React__default.createElement(Toolbar, null,
                React__default.createElement(FlexRow, { flex: 1 },
                    React__default.createElement(Button, { minimal: true, icon: "refresh", onClick: function () { return _this.fetch(); } }),
                    this.props.multiple && this.formatSelection(),
                    this.props.multiple &&
                        React__default.createElement("div", { className: "patterns-data-table-pagination-actions" }, this.props.actions && this.props.actions)),
                React__default.createElement(FlexColumn, { style: { width: 600 } }, this.renderPagination()),
                React__default.createElement(FlexColumn, { flex: 1 }, "\u00A0")));
    };
    return DataTable;
}(Component));
...
function DeleteAction(_a) {
    ...
    return React__default.createElement(Button, { disabled: disabled, text: t('delete'), icon: "trash", intent: "danger", small: true, className: "patterns-data-table-action", onClick: onClick });
}

___$insertStyle("/*\n * Copyright 2017 Palantir Technologies, Inc. All rights reserved.\n */\n.patterns-notifier .bp3-toast-message {\n  align-self: center;\n}\n.patterns-notifier .bp3-toast-message .patterns-notifier-message {\n  text-transform: uppercase;\n  font-size: 12px;\n  margin-top: 4px;\n}");

var PatternAppToaster = Toaster.create({
...
var Notifier = /** @class */ (function () {
    ...
    Notifier.loader = function (icon) {
        return PatternAppToaster.show({
            message: React__default.createElement(FlexColumn, { style: { alignItems: 'center' } },
                React__default.createElement(ProgressBar, { intent: "primary" }),
                React__default.createElement("div", { className: "patterns-notifier-message" }, t('pleaseWait'))),
            icon: icon,
            intent: 'none',
            timeout: 0
        });
    ...
    return React__default.createElement(FlexColumn, { flex: 1 },
        React__default.createElement(ItemDocumentItemRow, { key: "invoice-item-" + item.index },
            React__default.createElement(FlexRow, { flex: 6 },
                React__default.createElement(InputGroup, { fill: true, placeholder: t('edit'), value: item.name, onChange: function (evt) { return onNameChange(evt.currentTarget.value); }, name: "name" })),
            !free && React__default.createElement(React__default.Fragment, null,
                React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                    React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right " + (item.vatTotalOnly ? 'faded' : ''), placeholder: t('edit'), value: item.price.getValue(), onValueChange: onPriceChange, disabled: item.vatTotalOnly }),
                    React__default.createElement(ItemDocumentCurrency, { style: { opacity: item.vatTotalOnly ? 0.15 : 1 } }, currency.symbol)),
                React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                    React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", placeholder: t('edit'), value: item.unitPriceWithVat.getValue(), onValueChange: onPriceWithVatChange }),
                    React__default.createElement(ItemDocumentCurrency, { style: { opacity: item.vatTotalOnly ? 0.15 : 1 } }, currency.symbol)),
                React__default.createElement(FlexRow, __assign({}, rightRowProps),
                    React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right", placeholder: t('edit'), value: item.quantity, onValueChange: onQuantityChange }),
                ...
                React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 3 }),
                    React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right " + (item.vatTotalOnly ? 'faded' : ''), placeholder: t('edit'), value: item.linePrice.getValue(), onValueChange: onLinePriceChange, disabled: item.vatTotalOnly }),
                    React__default.createElement(ItemDocumentCurrency, { style: { opacity: item.vatTotalOnly ? 0.15 : 1 } }, currency.symbol))),
            !free && showVat &&
                React__default.createElement(React__default.Fragment, null,
                    React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                        React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right " + (item.vatTotalOnly ? 'faded' : ''), placeholder: t('edit'), value: item.vat, onValueChange: onVatChange, disabled: item.vatTotalOnly }),
                        React__default.createElement(ItemDocumentCurrency, { style: { opacity: item.vatTotalOnly ? 0.15 : 1 } }, "%")),
                    React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                        React__default.createElement(EditableText, { disabled: true, className: "align-right " + (item.vatTotalOnly ? 'faded' : ''), placeholder: t('edit'), value: "" + instance.settings.format.price(parseFloat(item.vatPrice.getValue())) }),
                        React__default.createElement(ItemDocumentCurrency, { style: { opacity: item.vatTotalOnly ? 0.15 : 1 } }, currency.symbol))),
            free && React__default.createElement(React__default.Fragment, null,
                React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                    React__default.createElement(InputGroup, { fill: true, placeholder: t('edit'), value: item.custom1, onChange: function (evt) { return onCustomChange(evt.currentTarget.value, 'custom1'); } })),
                React__default.createElement(FlexRow, { flex: 3 },
                    React__default.createElement(InputGroup, { fill: true, placeholder: t('edit'), value: item.custom2, onChange: function (evt) { return onCustomChange(evt.currentTarget.value, 'custom2'); } })),
                React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 2 }),
                    React__default.createElement(InputGroup, { fill: true, placeholder: t('edit'), value: item.custom3, onChange: function (evt) { return onCustomChange(evt.currentTarget.value, 'custom3'); } })),
                React__default.createElement(FlexRow, __assign({}, rightRowProps),
                    React__default.createElement(InputGroup, { fill: true, className: "align-right", placeholder: t('edit'), value: item.custom4, onChange: function (evt) { return onCustomChange(evt.currentTarget.value, 'custom4'); } }))),
            React__default.createElement(FlexRow, __assign({}, rightRowProps, { flex: 3 }),
                React__default.createElement(NumericInput, { fill: true, buttonPosition: "none", className: "align-right", placeholder: t('edit'), value: item.linePriceWithVat.getValue(), onValueChange: onLinePriceWithVatChange }),
                React__default.createElement(ItemDocumentCurrency, null, currency.symbol))),
        editableCode && React__default.createElement(ItemDocumentItemRow, { key: "invoice-item-code-" + item.index },
            React__default.createElement(FlexRow, { flex: 5 },
                React__default.createElement(InputGroup, { fill: true, placeholder: t('edit_code'), value: item.code, onChange: function (evt) { return onCodeChange(evt.currentTarget.value); }, name: "code" })),
    ...
    DocumentItemsView.prototype.renderItems = function () {
        ...
        return this.props.document.items.map(function (item, index) {
            return React__default.createElement("div", { key: "item-document-item-" + index, style: { flex: 1 } },
                React__default.createElement(Popover, { key: "document-item-popover-" + index, interactionKind: PopoverInteractionKind.HOVER, position: PopoverPosition.RIGHT },
                    React__default.createElement(InvoiceItemView, { free: _this.props.free || false, currency: currency, editableCode: _this.props.editableCode, item: item, onChange: _this.change, showVat: _this.props.showVat }),
                    React__default.createElement(ButtonGroup, null,
                        React__default.createElement(Button, { minimal: true, intent: "none", icon: item.vatTotalOnly ? "unlock" : "lock", onClick: function () { return _this.lock(item); } }),
                        React__default.createElement(Button, { minimal: true, intent: "danger", icon: "trash", onClick: function () { return _this.trash(item); } }),
                        React__default.createElement(Button, { minimal: true, intent: "none", icon: "duplicate", onClick: function () { return _this.duplicate(item); } }))));
        });
    };
            ...
            React__default.createElement(ItemDocumentItemsHeaderRow, null,
                React__default.createElement(FlexColumn, { flex: 6 },
                    React__default.createElement(ItemDocumentTableHeader, null,
                        ...
                        " / ",
                        t('code'))),
                !this.props.free && React__default.createElement(React__default.Fragment, null,
                    ...
                    React__default.createElement(FlexColumn, { flex: 2 },
                        React__default.createElement(ItemDocumentTableHeader, { align: "right" }, t('unitPriceWithVat'))),
                    React__default.createElement(FlexColumn, { flex: 2 },
                ...
                this.props.free && React__default.createElement(React__default.Fragment, null,
                    React__default.createElement(FlexColumn, { flex: 2 },
                        React__default.createElement(ItemDocumentTableHeader, { align: "right" })),
                    React__default.createElement(FlexColumn, { flex: 3 },
                        React__default.createElement(ItemDocumentTableHeader, { align: "right" })),
                    React__default.createElement(FlexColumn, { flex: 2 },
                        React__default.createElement(ItemDocumentTableHeader, { align: "right" })),
...
var ContactForm = /** @class */ (function (_super) {
    ...
    ContactForm.prototype.renderSuggestItem = function (contact, options) {
        return React__default.createElement(MenuItem, { key: "contact-" + contact.id, text: contact.getName(), onClick: options.handleClick });
    };
    ContactForm.prototype.renderSuggest = function () {
        var _this = this;
        var newItem = function (click) { return React__default.createElement(MenuItem, { intent: "success", icon: "plus", text: "Nov\u00FD klient", onClick: click }); };
        return React__default.createElement(FlexRow, null,
            React__default.createElement(ContactSuggest, { fill: true, className: "suggest-minimal patterns-contact-form-suggest", items: this.state.results, inputValueRenderer: function (contact) { return contact.name || contact.fullName; }, itemRenderer: this.renderSuggestItem, onItemSelect: function (item) { return _this.props.onReplace(item); }, query: this.state.query, selectedItem: this.props.contact, createNewItemFromQuery: function (query) { return new Contact({ name: query }); }, createNewItemRenderer: function (query, active, handleClick) { return newItem(handleClick); }, noResults: React__default.createElement(MenuItem, { text: t('noResults') }), onQueryChange: function (query) { return __awaiter(_this, void 0, void 0, function () {
                    var results;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
            ...
            React__default.createElement(Button, { minimal: true, style: { width: 30 }, icon: "cross", onClick: function () { return _this.setState({ results: [], query: '' }); } }));
    };
        ...
        return React__default.createElement(AddressBoxName, null, !this.props.disabled ?
            ...
            :
                React__default.createElement("div", { className: "suggest-minimal patterns-contact-form-suggest" },
                    React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.name, onChange: function (evt) { return _this.props.onChange('name', evt.currentTarget.value); }, placeholder: t('name') })));
    };
            ...
            React__default.createElement(AddressBoxOther, null,
                React__default.createElement(FlexColumn, null,
                    React__default.createElement(FlexRow, { style: { height: 26 } },
                        React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.street, onChange: function (evt) { return _this.props.onChange('street', evt.currentTarget.value); }, placeholder: t('street') })),
                    (!this.props.disabled || this.props.contact.street2.length > 0) &&
                        React__default.createElement(FlexRow, { style: { height: 26 } },
                            React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.street2, onChange: function (evt) { return _this.props.onChange('street2', evt.currentTarget.value); }, placeholder: t('street2') })),
                ...
                React__default.createElement(FlexRow, { style: { height: 26 } },
                    React__default.createElement(AddressBoxVatLabel, { style: { flex: 1 } },
                        React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.zip, onChange: function (evt) { return _this.props.onChange('zip', evt.currentTarget.value); }, placeholder: t('zip') })),
                    React__default.createElement(AddressBoxVatValue, { style: { flex: 3 } },
                        React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.city, onChange: function (evt) { return _this.props.onChange('city', evt.currentTarget.value); }, placeholder: t('city') }))),
                React__default.createElement(FlexRow, { style: { height: 26 } },
                    React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.country, onChange: function (evt) { return _this.props.onChange('country', evt.currentTarget.value); }, placeholder: t('country') }))),
            React__default.createElement(FlexRow, { flex: 1 },
                React__default.createElement(FlexColumn, { flex: 11, style: { marginTop: 14 } },
                    (!this.props.disabled || this.props.contact.businessId.length > 0) &&
                        React__default.createElement(FlexRow, { flex: 1 },
                            ...
                            React__default.createElement(AddressBoxVatValue, { style: { flex: 3 } },
                                React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.businessId, onChange: function (evt) { return _this.props.onChange('businessId', evt.currentTarget.value); }, placeholder: t('businessId') }))),
                    (!this.props.disabled || this.props.contact.vatPayerId.length > 0) &&
                        React__default.createElement(FlexRow, null,
                            ...
                            React__default.createElement(AddressBoxVatValue, { style: { flex: 3 } },
                                React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.vatPayerId, onChange: function (evt) { return _this.props.onChange('vatPayerId', evt.currentTarget.value); }, placeholder: t('vatPayerId') }))),
                    (!this.props.disabled || this.props.contact.vatId.length > 0) &&
                        React__default.createElement(FlexRow, null,
                            React__default.createElement(AddressBoxVatLabel, null, "I\u010C DPH:"),
                            React__default.createElement(AddressBoxVatValue, { style: { flex: 3 } },
                                React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.vatId, onChange: function (evt) { return _this.props.onChange('vatId', evt.currentTarget.value); }, placeholder: t('vatId') }))))));
    };
    return ContactForm;
}(React__default.Component));

var PaymentMethodSelect = Select.ofType();
var InvoiceItemsView = DocumentItemsView.ofType();
...
var InvoiceView = /** @class */ (function (_super) {
    ...
    InvoiceView.prototype.renderVatRecap = function (currency) {
        var header = this.props.document.vats.length > 0 ?
            React__default.createElement(FlexRow, { flex: 1, style: { paddingTop: 24 } },
                React__default.createElement(FlexColumn, { flex: 11 }),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-header-column" }, t('vatRecap')),
                React__default.createElement(FlexColumn, { flex: 2, className: "patterns-item-document-header-column bordered" }, t('vat')),
                React__default.createElement(FlexColumn, { flex: 2, className: "patterns-item-document-header-column bordered" }, t('vatBase')),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-header-column bordered" }, t('vatValue')))
            :
                null;
        var rows = this.props.document.vats.map(function (vat, index) {
            return React__default.createElement(FlexRow, { key: "invoice-vat-" + index, flex: 1, style: { height: 24, alignItems: 'center' } },
                React__default.createElement(FlexColumn, { flex: 14 }),
                React__default.createElement(FlexColumn, { style: { textAlign: 'right' }, flex: 2 },
                    vat.vat,
                    " %"),
                React__default.createElement(FlexColumn, { style: { textAlign: 'right' }, flex: 2 }, instance.format.price(vat.base, currency)),
                React__default.createElement(FlexColumn, { style: { textAlign: 'right' }, flex: 3 }, instance.format.price(vat.price, currency)));
        });
    ...
    InvoiceView.prototype.renderTotal = function (currency) {
        return React__default.createElement(FlexRow, { flex: 1, style: { height: 42, alignItems: 'center' } },
            React__default.createElement(FlexColumn, { flex: 11 }),
            React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-header-column" }, t('total')),
            React__default.createElement(FlexColumn, { flex: 7, className: "patterns-item-document-total" }, instance.format.price(instance.settings.invoices.showVat ? this.props.document.itemsTotalWithVat : this.props.document.itemsTotal, currency)));
    };
    InvoiceView.prototype.render = function () {
        ...
        return React__default.createElement(Wrapper, null,
            React__default.createElement(Page, { style: { padding: '12mm' } },
                React__default.createElement(Header$1, null,
                    ...
                    React__default.createElement(FlexColumn, { flex: 4, style: { flex: 4 } },
                        React__default.createElement(HeaderCode, null,
                            React__default.createElement(InputGroup, { fill: true, disabled: true, defaultValue: this.props.document.code, 
                        ...
                        React__default.createElement(DocumentType, null, t('invoice.type')))),
                ...
                React__default.createElement(FlexRow, { className: "patterns-item-document-dates" },
                    React__default.createElement(FlexRow, { flex: 1, className: "patterns-item-document-dates-column", style: { marginRight: 30 } },
                        React__default.createElement(FlexColumn, { flex: 1 },
                            React__default.createElement(FlexRow, { className: "patterns-item-document-detail-select" }, t('issuedBy')),
                            ...
                            React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, t('dateDue')))),
                    React__default.createElement(FlexRow, { flex: 2, className: "patterns-item-document-dates-column" },
                        React__default.createElement(FlexColumn, { style: { marginLeft: 5, fontWeight: 'bold' } },
                            React__default.createElement(NamedSelect, { className: "patterns-item-document-select-offset", items: this.state.people, itemRenderer: function (item, options) { return React__default.createElement(MenuItem, { key: "patterns-item-document-issued-" + item.id, text: item.name, onClick: options.handleClick }); }, onItemSelect: function (item) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                ...
                                React__default.createElement(Button, { minimal: true, text: this.props.document.issuedBy, rightIcon: "chevron-down" })),
                            React__default.createElement(DateInput, { formatDate: instance.format.date, parseDate: instance.format.parseDate, value: this.props.document.createdAt, onChange: function (date) { return _this.props.onChange('createdAt', date); } }),
                            React__default.createElement(DateInput, { formatDate: instance.format.date, parseDate: instance.format.parseDate, value: this.props.document.deliveryDate, onChange: function (date) { return _this.props.onChange('deliveryDate', date); } }),
                            React__default.createElement(DateInput, { formatDate: instance.format.date, parseDate: instance.format.parseDate, value: this.props.document.dueDate, onChange: function (date) { return _this.props.onChange('dueDate', date); } }))),
                        ...
                        React__default.createElement(FlexColumn, { flex: 1 },
                            ...
                            paymentMethod.code === PaymentMethod.bankTransfer.code &&
                                React__default.createElement(React__default.Fragment, null,
                                    ...
                                    instance.settings.invoices.showSymbols && React__default.createElement(React__default.Fragment, null,
                        ...
                        React__default.createElement(FlexColumn, { flex: 1, style: { fontWeight: 'bold' } },
                            React__default.createElement(FlexRow, { className: "patterns-item-document-detail-select" },
                                React__default.createElement(PaymentMethodSelect, { items: instance.settings.payment.methods, activeItem: paymentMethod, onItemSelect: function (item) {
                                    ...
                                    }, itemRenderer: function (item, options) { return React__default.createElement(MenuItem, { key: "invoice-payment-method-" + item.code, text: item.title, onClick: options.handleClick }); } },
                ...
                React__default.createElement(InvoiceItemsView, { editableCode: this.props.editableCode, showVat: instance.settings.invoices.showVat, document: this.props.document, onChange: function (items) { return _this.props.onChange('items', items); } }),
                React__default.createElement(FlexRow, null,
                    ...
                    React__default.createElement(FlexRow, { flex: 10, style: { paddingTop: 24 } })),
                instance.settings.invoices.showVat && this.renderVatRecap(currency),
                this.renderTotal(currency),
                React__default.createElement(FlexRow, { flex: 1, style: { paddingTop: 48 } },
                    React__default.createElement(ControlGroup, { fill: true, style: { flex: 1 } },
                        React__default.createElement(FormGroup, { label: t('note') },
                            React__default.createElement(TextArea, { fill: true, value: this.props.document.note, onChange: function (evt) { return _this.props.onChange('note', evt.currentTarget.value); }, className: "patterns-item-document-note" })))),
                React__default.createElement(FlexRow, { style: { marginTop: 120 } },
                    ...
                    React__default.createElement(FlexColumn, { flex: 1, className: "patterns-item-document-signature" },
                        this.props.signature && React__default.createElement("img", { alt: "logo", src: this.props.signature }),
                        React__default.createElement("div", { className: "dots" }, "......................................................."),
...
var NamedSelect$1 = Select.ofType();
var OrderView = /** @class */ (function (_super) {
    ...
    OrderView.prototype.renderTotal = function (currency) {
        return React__default.createElement(FlexRow, { flex: 1, style: { height: 42, alignItems: 'center' } },
            React__default.createElement(FlexColumn, { flex: 11 }),
            React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-header-column" }, t('total')),
            React__default.createElement(FlexColumn, { flex: 7, className: "patterns-item-document-total" }, instance.format.price(instance.settings.orders.showVat ? this.props.document.itemsTotalWithVat : this.props.document.itemsTotal, currency)));
    };
        ...
        return React__default.createElement(Wrapper, null,
            React__default.createElement(Page, null,
                React__default.createElement(Header$1, null,
                    ...
                    React__default.createElement(FlexColumn, { flex: 4, style: { flex: 4 } },
                        React__default.createElement(HeaderCode, null,
                            React__default.createElement(InputGroup, { fill: true, value: this.props.document.name || t('order.new'), onChange: function (evt) { return _this.props.onChange('name', evt.currentTarget.value); }, className: "patterns-item_document-header-name" })),
                        React__default.createElement(DocumentType, null,
                            t('order.type'),
                            " ",
                ...
                React__default.createElement(FlexRow, { className: "patterns-item-document-dates" },
                    ...
                    React__default.createElement(FlexRow, { flex: 2, className: "patterns-item-document-dates-column" },
                        React__default.createElement(FlexColumn, { style: { marginLeft: 5, fontWeight: 'bold' } },
                            React__default.createElement(NamedSelect$1, { className: "patterns-item-document-select-offset", items: this.state.people, itemRenderer: function (item, options) { return React__default.createElement(MenuItem, { key: "patterns-item-document-issued-" + item.id, text: item.name, onClick: options.handleClick }); }, onItemSelect: function (item) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.props.onChange('issuedBy', item.name)];
                                            case 1:
                        ...
                        React__default.createElement(FlexColumn, { flex: 1 },
                            ...
                            paymentMethod.code === PaymentMethod.bankTransfer.code &&
                                React__default.createElement(React__default.Fragment, null,
                                    React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, t('bank')),
                                    React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, t('bankAccount')),
                                    instance.settings.orders.showSymbols && React__default.createElement(React__default.Fragment, null,
                                        React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, t('variableSymbol')),
                                        React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, t('constantSymbol'))))),
                        React__default.createElement(FlexColumn, { flex: 1, style: { fontWeight: 'bold' } },
                            React__default.createElement(FlexRow, { className: "patterns-item-document-detail-select" },
                                React__default.createElement(PaymentMethodSelect$1, { items: instance.settings.payment.methods, activeItem: paymentMethod, onItemSelect: function (item) {
                                        _this.props.onChange('paymentMethod', item.code);
                                    }, itemRenderer: function (item, options) { return React__default.createElement(MenuItem, { key: "order-payment-method-" + item.code, text: item.title, onClick: options.handleClick }); } },
                                    React__default.createElement(Button, { style: { marginLeft: -10, fontWeight: 'bold' }, minimal: true, rightIcon: "chevron-down", text: paymentMethod.title }))),
                            paymentMethod.code === PaymentMethod.bankTransfer.code &&
                                React__default.createElement(React__default.Fragment, null,
                                    React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, instance.settings.bank.name),
                                    ...
                                    instance.settings.orders.showSymbols && React__default.createElement(React__default.Fragment, null,
                                        React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, this.props.document.code),
                                        React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, "0308")))))),
                React__default.createElement(OrderItemsView, { editableCode: this.props.editableCode, showVat: instance.settings.orders.showVat, document: this.props.document, onChange: function (items) { return _this.props.onChange('items', items); } }),
                React__default.createElement(FlexRow, null,
                    React__default.createElement(FlexRow, { flex: 4, style: { marginTop: 12, alignItems: 'start' } },
                        React__default.createElement(Button, { minimal: true, intent: "success", icon: "plus", text: t('newItem'), onClick: function () {
...
var ContactSuggest$1 = Suggest.ofType();
var ContactForm$1 = /** @class */ (function (_super) {
    __extends(ContactForm, _super);
    function ContactForm(props) {
        var _this = _super.call(this, props) || this;
        _this.state = {
    ...
    ContactForm.prototype.renderSuggest = function () {
        ...
        var newItem = function (click) { return React__default.createElement(MenuItem, { intent: "success", icon: "plus", text: "Nov\u00FD klient", onClick: click }); };
        return React__default.createElement(FlexRow, null,
            React__default.createElement(ContactSuggest$1, { fill: true, className: "suggest-minimal patterns-contact-form-suggest", items: this.state.results, inputValueRenderer: function (contact) { return contact.name || contact.fullName; }, itemRenderer: this.renderSuggestItem, onItemSelect: function (item) { return _this.props.onReplace(item); }, query: this.state.query, selectedItem: this.props.contact, createNewItemFromQuery: function (query) { return new Contact({ name: query }); }, createNewItemRenderer: function (query, active, handleClick) { return newItem(handleClick); }, noResults: React__default.createElement(MenuItem, { text: t('noResults') }), onQueryChange: function (query) { return __awaiter(_this, void 0, void 0, function () {
                    var results;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.setState({ query: query })];
            ...
            React__default.createElement(AddressBoxOther, null,
                ...
                React__default.createElement(FlexRow, { style: { height: 26 } },
                    ...
                    React__default.createElement(AddressBoxVatValue, { style: { flex: 3 } },
                        React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.city, onChange: function (evt) { return _this.props.onChange('city', evt.currentTarget.value); }, placeholder: t('city') }))),
                React__default.createElement(FlexRow, { style: { height: 26 } },
                    React__default.createElement(InputGroup, { fill: true, disabled: this.props.disabled, value: this.props.contact.phone, onChange: function (evt) { return _this.props.onChange('phone', evt.currentTarget.value); }, placeholder: t('phone') }))),
            this.props.detail && this.props.detail);
    };
    return ContactForm;
}(React__default.Component));

var PaymentMethodSelect$2 = Select.ofType();
var OrderItemsView$1 = DocumentItemsView.ofType();
var NamedSelect$2 = Select.ofType();
var CustomOrderView = /** @class */ (function (_super) {
    ...
    CustomOrderView.prototype.renderTotal = function (currency) {
        return React__default.createElement(React__default.Fragment, null,
            React__default.createElement(FlexRow, { flex: 1, style: { alignItems: 'center' } },
                React__default.createElement(FlexColumn, { flex: 11 }),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-header-column" }, "CENA MATERI\u00C1L"),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-total" }, instance.format.price(parseFloat(this.props.document.itemsPrice().getValue()) / 1.2, currency)),
                React__default.createElement(FlexColumn, { flex: 4, className: "patterns-item-document-total" }, instance.format.price(parseFloat(this.props.document.itemsPrice().getValue()), currency))),
            React__default.createElement(FlexRow, { flex: 1, style: { alignItems: 'center' } },
                React__default.createElement(FlexColumn, { flex: 11 }),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-header-column" }, "CENA PR\u00C1CA"),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-total" }, instance.format.price(parseFloat(this.props.document.workPrice().getValue()) / 1.2, currency)),
                React__default.createElement(FlexColumn, { flex: 4, className: "patterns-item-document-total" }, instance.format.price(parseFloat(this.props.document.workPrice().getValue()), currency))),
            React__default.createElement(FlexRow, { flex: 1, style: { alignItems: 'center' } },
                React__default.createElement(FlexColumn, { flex: 11 }),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-header-column" }, "CENA SPOLU"),
                React__default.createElement(FlexColumn, { flex: 3, className: "patterns-item-document-total" }, instance.format.price(this.props.document.itemsTotal, currency)),
                React__default.createElement(FlexColumn, { flex: 4, className: "patterns-item-document-total" }, instance.format.price(this.props.document.itemsTotalWithVat, currency))));
    };
        ...
        return React__default.createElement(Wrapper, null,
            React__default.createElement(Page, null,
                React__default.createElement(Header$1, null,
                    ...
                    React__default.createElement(FlexColumn, { flex: 4, style: { flex: 4 } },
                        React__default.createElement(HeaderCode, null,
                            React__default.createElement("div", { className: "patterns-item_document-header-name" }, this.props.document.exists ? this.props.document.code : 'Nová objednávka')),
                ...
                React__default.createElement(FlexRow, { style: { alignItems: 'flex-start' } },
                    ...
                    React__default.createElement(ContactForm$1, { key: "address-customer", header: t('customer'), contact: this.props.document.customer, onChange: function (property, value) {
                            var contact = new Contact(_this.props.document.customer.clone);
                            contact[property] = value;
                            _this.props.onChange('customer', contact);
                ...
                React__default.createElement(FlexRow, { className: "patterns-item-document-dates" },
                    ...
                    React__default.createElement(FlexRow, { flex: 2, className: "patterns-item-document-dates-column" },
                        React__default.createElement(FlexColumn, { style: { marginLeft: 5, fontWeight: 'bold' } },
                            React__default.createElement(InputGroup, { style: { marginTop: 4 }, value: this.props.document.issuedBy, onChange: function (evt) {
                    ...
                    React__default.createElement(FlexRow, { flex: 2, className: "patterns-item-document-dates-column", style: { marginLeft: 5 } },
                        ...
                        React__default.createElement(FlexColumn, { flex: 1, style: { fontWeight: 'bold' } },
                            React__default.createElement(FlexRow, { className: "patterns-item-document-detail-select" },
                                React__default.createElement(PaymentMethodSelect$2, { items: instance.settings.payment.methods, activeItem: paymentMethod, onItemSelect: function (item) {
                                        _this.props.onChange('paymentMethod', item.code);
                                    }, itemRenderer: function (item, options) { return React__default.createElement(MenuItem, { key: "order-payment-method-" + item.code, text: item.title, onClick: options.handleClick }); } },
                                    React__default.createElement(Button, { style: { marginLeft: -10, fontWeight: 'bold' }, minimal: true, rightIcon: "chevron-down", text: paymentMethod.title }))),
                            paymentMethod.code === PaymentMethod.bankTransfer.code &&
                                React__default.createElement(React__default.Fragment, null,
                                    ...
                                    instance.settings.orders.showSymbols && React__default.createElement(React__default.Fragment, null,
                                        React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, this.props.document.code),
                                        React__default.createElement(FlexRow, { className: "patterns-item-document-detail" }, "0308")))))),
                React__default.createElement(OrderItemsView$1, { free: this.props.free, editableCode: this.props.editableCode, showVat: instance.settings.orders.showVat, document: this.props.document, onChange: function (items) { return _this.props.onChange('items', items); } }),
                React__default.createElement(FlexRow, null,
                    React__default.createElement(FlexRow, { flex: 4, style: { marginTop: 12, alignItems: 'start' } },
                        React__default.createElement(Button, { minimal: true, intent: "success", icon: "plus", text: t('newItem'), onClick: function () {
                                var order = new Order(_this.props.document.clone);
...
var libCov = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
(function (root, factory) {
    if ( module.exports && typeof commonjsRequire === 'function') {
        // CommonJS
        module.exports = factory();
    } else {
        // Browser globals
...
var promiseQueue = process.env.PROMISE_QUEUE_COVERAGE ?
    libCov :
    lib;
...
function ContactForm$2(_a) {
    var contact = _a.contact, simple = _a.simple;
    return React__default.createElement(View, { style: { flexDirection: 'column', marginTop: 0 } },
        React__default.createElement(View, { style: { flexDirection: 'column' } },
            React__default.createElement(Text, { style: styles.nameLine }, contact.name),
            React__default.createElement(Text, { style: styles.addressLine }, contact.street),
            React__default.createElement(Text, { style: styles.addressLine }, contact.street2),
            React__default.createElement(View, { style: { flexDirection: 'row' } },
                React__default.createElement(Text, { style: __assign(__assign({}, styles.addressLine), { flex: 1, marginRight: 10 }) }, contact.zip),
                React__default.createElement(Text, { style: __assign(__assign({}, styles.addressLine), { flex: 3 }) }, contact.city)),
            React__default.createElement(Text, { style: styles.addressLine }, contact.country)),
        !simple && React__default.createElement(View, { style: { flexDirection: 'row', marginTop: 6 } },
            React__default.createElement(View, { style: { flexDirection: 'column', flex: 1 } },
                React__default.createElement(Text, { style: styles.addressLine }, t('businessId')),
                React__default.createElement(Text, { style: styles.addressLine }, t('vatPayerId')),
                React__default.createElement(Text, { style: styles.addressLine }, t('vatId'))),
            React__default.createElement(View, { style: { flexDirection: 'column', flex: 3 } },
                React__default.createElement(Text, { style: styles.addressLine }, contact.businessId),
                React__default.createElement(Text, { style: styles.addressLine }, contact.vatPayerId),
                React__default.createElement(Text, { style: styles.addressLine }, contact.vatId))),
        false  );
}
...
var Header$2 = styled.View(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  flexDirection: row;\n"], ["\n  display: flex;\n  flexDirection: row;\n"])));
var Contacts = styled.View(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  flexDirection: row;\n  marginBottom: 2mm;\n"], ["\n  display: flex;\n  flexDirection: row;\n  marginBottom: 2mm;\n"])));
var Logo$1 = styled.View(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  flex: 1;\n"], ["\n  flex: 1;\n"])));
...
var HeaderCode$1 = styled.Text(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  text-align: right;\n  font-size: 22px;\n  font-weight: bold;\n  font-family: \"Oswald\";\n"], ["\n  text-align: right;\n  font-size: 22px;\n  font-weight: bold;\n  font-family: \"Oswald\";\n"])));
var DocumentType$1 = styled.Text(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  text-align: right;\n  font-size: 10px;\n  font-weight: bold;\n  color: ", ";\n  text-transform: uppercase;\n  font-family: \"Oswald Medium\";\n"], ["\n  text-align: right;\n  font-size: 10px;\n  font-weight: bold;\n  color: ", ";\n  text-transform: uppercase;\n  font-family: \"Oswald Medium\";\n"])), Colors.GRAY3);
...
function InvoicePrinter(_a) {
    ...
    var paymentMethod = instance.getPaymentMethod(document.paymentMethod);
    var currency = instance.getCurrency(document.currency);
    var renderHeader = function (page) {
        return React__default.createElement(Row, { key: "header-" + page, style: { marginTop: 0, borderBottomWidth: 2, borderColor: Colors.LIGHT_GRAY3 } },
            React__default.createElement(Column, { style: { flex: 6 } },
                React__default.createElement(TableHeaderItem, null,
                    t('title'),
                    " / ",
                    t('code'))),
            !free && React__default.createElement(React__default.Fragment, null,
                React__default.createElement(Column, { style: { flex: 2 } },
                    React__default.createElement(TableHeader, { align: "right" }, t('unitPriceNoVat'))),
                React__default.createElement(Column, { style: { flex: 2 } },
                    React__default.createElement(TableHeader, { align: "right" }, t('unitPriceWithVat'))),
                React__default.createElement(Column, { style: { flex: 2 } },
                    React__default.createElement(TableHeader, { align: "right" }, t('quantity'))),
                React__default.createElement(Column, { style: { flex: 3 } },
                    React__default.createElement(TableHeader, { align: "right" }, t('linePriceNoVat')))),
            !free && instance.settings.invoices.showVat && React__default.createElement(React__default.Fragment, null,
                React__default.createElement(Column, { style: { flex: 2 } },
                    React__default.createElement(TableHeader, { align: "right" }, t('vat'))),
                React__default.createElement(Column, { style: { flex: 2 } },
                    React__default.createElement(TableHeader, { align: "right" }, t('vatPrice'))),
                React__default.createElement(Column, { style: { flex: 3 } },
                    React__default.createElement(TableHeader, { align: "right" }, t('linePriceWithVat')))),
            free && React__default.createElement(React__default.Fragment, null,
                React__default.createElement(Column, { style: { flex: 2 } },
    ...
    var renderItems = function (from, to) {
        return document.items.slice(from, to).map(function (item, index) {
            var itemRow = React__default.createElement(Row, { key: "item-" + index },
                React__default.createElement(Column, { style: { flex: 6 } },
                    React__default.createElement(TableCellItem, { style: { textAlign: 'left' } }, item.name)),
                !free && React__default.createElement(React__default.Fragment, null,
                    React__default.createElement(Column, { style: { flex: 2 } },
                        React__default.createElement(TableCell, { align: "right" }, instance.format.price(item.price, currency))),
                    React__default.createElement(Column, { style: { flex: 2 } },
                        React__default.createElement(TableCell, { align: "right" }, instance.format.price(item.unitPriceWithVat, currency))),
                    React__default.createElement(Column, { style: { flex: 2 } },
                        React__default.createElement(TableCell, { align: "right" },
                            item.quantity,
                            " ",
                            item.unit)),
                    React__default.createElement(Column, { style: { flex: 3 } },
                        React__default.createElement(TableCell, { align: "right" }, instance.format.price(item.linePriceWithVat, currency)))),
                !free && instance.settings.orders.showVat &&
                    React__default.createElement(React__default.Fragment, null,
                        React__default.createElement(Column, { style: { flex: 2 } },
                            React__default.createElement(TableCell, { align: "right" },
                                item.vat,
                                " %")),
                        React__default.createElement(Column, { style: { flex: 2 } },
                            React__default.createElement(TableCell, { align: "right" }, instance.format.price(item.vatPrice, currency))),
                        React__default.createElement(Column, { style: { flex: 3 } },
                            React__default.createElement(TableCell, { style: { fontFamily: "Oswald" }, align: "right" }, instance.format.price(item.linePriceWithVat, currency)))),
                free && React__default.createElement(React__default.Fragment, null,
                    React__default.createElement(Column, { style: { flex: 2 } },
                        React__default.createElement(TableCell, null, item.custom1)),
                    React__default.createElement(Column, { style: { flex: 3 } },
                        React__default.createElement(TableCell, null, item.custom2)),
                    React__default.createElement(Column, { style: { flex: 2 } },
                        React__default.createElement(TableCell, null, item.custom3)),
                    React__default.createElement(Column, { style: { flex: 3 } },
                        React__default.createElement(TableCell, null, item.custom4)),
                    React__default.createElement(Column, { style: { flex: 3 } },
                        React__default.createElement(TableCell, { style: { fontFamily: "Oswald" }, align: "right" },
                            item.name.length > 1 && instance.format.price(item.linePriceWithVat, currency),
                            item.name.length <= 1 && React__default.createElement(Text, { style: { color: 'white' } }, "0")))));
            var itemRows = [];
            ...
            //   </Row>)
            // }
            return React__default.createElement(React__default.Fragment, { key: "item-fragment-" + index }, itemRows);
        });
    };
    var renderTotal = function (currency) {
        return React__default.createElement(React__default.Fragment, null,
            React__default.createElement(Row, { style: { flex: 1, alignItems: 'center' } },
                React__default.createElement(Column, { style: { flex: 14 } }),
                React__default.createElement(Column, { style: { flex: 3 } },
                    React__default.createElement(TableHeader, { style: { textAlign: 'right' } }, "SPOLU BEZ DPH")),
                React__default.createElement(Column, { style: { flex: 4 } },
                    React__default.createElement(TableHeader, { style: { textAlign: 'right' } }, "SPOLU S DPH 20%"))),
            React__default.createElement(Row, { style: { flex: 1, alignItems: 'center' } },
                React__default.createElement(Column, { style: { flex: 14 } },
                    React__default.createElement(TableHeader, { style: { marginRight: 6 } }, "Cena materi\u00E1l")),
                React__default.createElement(Column, { style: { flex: 3 } },
                    React__default.createElement(Text, { style: {
                        ...
                        } }, instance.format.price(itemsPrice.divide(new bigDecimal(1.2), 2), currency))),
                React__default.createElement(Column, { style: { flex: 4 } },
                    React__default.createElement(Text, { style: {
                            fontSize: 11,
                            fontFamily: 'Oswald',
                            textAlign: 'right',
                            backgroundColor: Colors.LIGHT_GRAY4
                        } }, instance.format.price(itemsPrice, currency)))),
            React__default.createElement(Row, { style: { flex: 1, alignItems: 'center' } },
                React__default.createElement(Column, { style: { flex: 14 } },
                    React__default.createElement(TableHeader, { style: { marginRight: 6 } }, "Cena pr\u00E1ca")),
                React__default.createElement(Column, { style: { flex: 3 } },
                    React__default.createElement(Text, { style: {
                            fontSize: 11,
                            fontFamily: 'Oswald',
                            textAlign: 'right',
                            backgroundColor: Colors.LIGHT_GRAY4
                        } }, instance.format.price(workPrice.divide(new bigDecimal(1.2), 2), currency))),
                React__default.createElement(Column, { style: { flex: 4 } },
                    React__default.createElement(Text, { style: {
                            fontSize: 11,
                            fontFamily: 'Oswald',
                            textAlign: 'right',
                            backgroundColor: Colors.LIGHT_GRAY4
                        } }, instance.format.price(workPrice, currency)))),
            React__default.createElement(Row, { style: { flex: 1, alignItems: 'center' } },
                React__default.createElement(Column, { style: { flex: 14 } },
                    React__default.createElement(TableHeader, { style: { marginRight: 6 } }, "Cena spolu")),
                React__default.createElement(Column, { style: { flex: 3 } },
                    React__default.createElement(Text, { style: {
                            fontSize: 11,
                            fontFamily: 'Oswald',
                            textAlign: 'right',
                            backgroundColor: Colors.LIGHT_GRAY4
                        } }, instance.format.price(document.itemsTotal, currency))),
                React__default.createElement(Column, { style: { flex: 4 } },
                    React__default.createElement(Text, { style: {
                            fontSize: 11,
                            fontFamily: 'Oswald',
                            textAlign: 'right',
                            backgroundColor: Colors.LIGHT_GRAY4
                        } }, instance.format.price(document.itemsTotalWithVat, currency)))));
    };
    var renderHead = function () {
        return React__default.createElement(Column, null,
            React__default.createElement(Header$2, null,
                React__default.createElement(Logo$1, null,
                    React__default.createElement(Image, { src: instance.settings.logo, style: { width: '40mm', marginTop: 0 } })),
                React__default.createElement(View, { style: { flex: 4 } },
                    React__default.createElement(HeaderCode$1, null, document.name || t('order.new')),
                    React__default.createElement(DocumentType$1, null,
                        quote ? 'Cenová ponuka' : 'Objednávka',
                        " ",
                        document.code))),
            React__default.createElement(Contacts, null,
                React__default.createElement(View, { style: { flex: 1, marginRight: 20 } },
                    React__default.createElement(Text, null)),
                React__default.createElement(View, { style: { flex: 2, borderTopWidth: 2, borderColor: Colors.LIGHT_GRAY3, marginRight: 20 } },
                    React__default.createElement(Text, { style: { fontSize: 9, fontWeight: 'bold', fontFamily: 'Oswald Medium', color: Colors.GRAY3 } }, t('vendor')),
                    React__default.createElement(ContactForm$2, { contact: document.vendor, simple: true })),
                React__default.createElement(View, { style: { flex: 2, borderTopWidth: 2, borderColor: Colors.LIGHT_GRAY3 } },
                    React__default.createElement(Text, { style: { fontSize: 9, fontWeight: 'bold', fontFamily: 'Oswald Medium', color: Colors.GRAY3 } }, t('customer')),
                    React__default.createElement(ContactForm$2, { contact: document.customer, simple: true }))),
            React__default.createElement(Contacts, null,
                React__default.createElement(View, { style: { flex: 1, borderTopWidth: 2, borderColor: Colors.LIGHT_GRAY3, marginRight: 20 } },
                    React__default.createElement(DefaultTextLabel, null, t('issuedBy')),
                    React__default.createElement(DefaultTextLabel, null, t('datePosted'))),
                React__default.createElement(View, { style: { flex: 2, borderTopWidth: 2, borderColor: Colors.LIGHT_GRAY3, marginRight: 20 } },
                    React__default.createElement(DefaultTextValue, null, document.issuedBy),
                    React__default.createElement(DefaultTextValue, null, instance.format.date(document.createdAt))),
                React__default.createElement(View, { style: { flex: 2, flexDirection: 'row', borderTopWidth: 2, borderColor: Colors.LIGHT_GRAY3 } },
                    React__default.createElement(View, { style: { flex: 1, flexDirection: 'column' } },
                        React__default.createElement(DefaultTextLabel, null, t('paymentMethod')),
                        paymentMethod.code === PaymentMethod.bankTransfer.code &&
                            React__default.createElement(React__default.Fragment, null,
                                React__default.createElement(DefaultTextLabel, null, t('bank')),
                                React__default.createElement(DefaultTextLabel, null, t('bankAccount')),
                                React__default.createElement(DefaultTextLabel, null, t('variableSymbol')))),
                    React__default.createElement(View, { style: { flex: 1, flexDirection: 'column' } },
                        React__default.createElement(DefaultTextValue, null, paymentMethod.title),
                        paymentMethod.code === PaymentMethod.bankTransfer.code &&
                            React__default.createElement(React__default.Fragment, null,
                                React__default.createElement(DefaultTextValue, null, instance.settings.bank.name),
                                React__default.createElement(DefaultTextValue, null, instance.settings.bank.account),
                                React__default.createElement(DefaultTextValue, null, document.numericCode()))))));
    };
    var renderEnding = function (page) {
        return React__default.createElement(React__default.Fragment, { key: "ending" },
            React__default.createElement(Row, null,
                React__default.createElement(Column, { style: { paddingTop: 24, flex: 1 } }, renderTotal(currency))),
            React__default.createElement(Row, { style: { paddingTop: 12, marginTop: 0, marginBottom: 0 } }),
            React__default.createElement(Row, { style: {
                    paddingTop: 24,
                    marginTop: '12mm',
                    bottom: '24mm',
                    textAlign: 'right',
                ...
                React__default.createElement(Column, { style: { flex: 1 } }),
                React__default.createElement(Column, { style: { flex: 1, justifyContent: 'right' }, className: "patterns-item-document-signature" },
                    React__default.createElement(Image, { src: document.signature, style: { width: '40mm' } }),
                    React__default.createElement(DefaultText, { style: { textAlign: 'right', marginTop: -20 } }, "......................................................."),
                    React__default.createElement(DefaultText, { style: { textAlign: 'right', fontFamily: 'Oswald Light', fontSize: 8, textTransform: 'uppercase', colors: Colors.LIGHT_GRAY1 } }, t('signature')))));
    };
    var renderPages = function () {
        var pages = [];
        var head = React__default.createElement(React__default.Fragment, { key: "page-0" },
            renderHead(),
            renderHeader(0));
        var footer = function (page) { return React__default.createElement(View, { fixed: true, key: "footer-" + page, style: {
                position: 'absolute',
                bottom: '10mm',
                width: '100vw',
                fontSize: 9,
            ...
            React__default.createElement(View, { style: { flex: 2, flexDirection: 'column' } },
                React__default.createElement(Text, { style: { textAlign: 'left', fontSize: 7 }, key: "footer-page-company-" + page + "-company" }, "Gargo s.r.o."),
                React__default.createElement(Text, { style: { textAlign: 'left', fontSize: 7 }, key: "footer-page-company-" + page + "-web" }, "web: http://www.gargo.sk"),
                React__default.createElement(Text, { style: { textAlign: 'left', fontSize: 7 }, key: "footer-page-company-" + page + "-email" }, "email: gargo@gargo.sk"),
                React__default.createElement(Text, { style: { textAlign: 'left', fontSize: 7 }, key: "footer-page-company-" + page + "-phone" }, "telef\u00F3n (predaj\u0148a): 0905 909 815 / 0911 109 785")),
            React__default.createElement(Column, { style: { flex: 2, alignItems: 'flex-end' } },
                React__default.createElement(Text, { fixed: true, style: { fontSize: 7, marginTop: 22 }, key: "footer-page-top-" + page }, "\u010Eakujeme za V\u00E1\u0161 \u010Das, ak ste boli spokojn\u00ED s na\u0161imi slu\u017Ebami, pros\u00EDme o zdi\u013Eanie a rezenciu na na\u0161u FB str\u00E1nku GARGO - krbov\u00E9 a inter\u00EDerov\u00E9 \u0161t\u00FAdio."),
                React__default.createElement(Text, { fixed: true, style: { textAlign: 'right' }, key: "footer-page-" + page, render: function (_a) {
        ...
        if (document.items.length <= PER_PAGE_FIRST) {
            // single page
            pages.push(React__default.createElement(Page$1, { key: "page-0", size: "A4", style: styles$1.page },
                head,
        ...
        for (var i = 0; i < itemPages; i++) {
            ...
            if (isLast) {
                content.push(renderEnding());
            }
            content.push(footer(i + 1));
            pages.push(React__default.createElement(Page$1, { key: "page-" + (i + 1), size: "A4", style: styles$1.page }, content));
        }
        return pages;
    };
    return React__default.createElement(Document, null, renderPages());
}
var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12, templateObject_13, templateObject_14;

export { Alignment, BaseModel, ColumnType, Confirm, Contact, Container, Currency, InvoicePrinter as CustomOrderPrinter, CustomOrderView, DataTable, DeleteAction, DocumentItem, FlexColumn, FlexRow, Invoice, InvoiceView, ItemDocument, localeManager as LocaleManager, Notifier, Order, OrderView, instance as PatternApp, PaymentMethod, PriceQuote, Queue, Return, Toolbar };
