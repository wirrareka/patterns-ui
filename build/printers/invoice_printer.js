...
export default function InvoicePrinter(_a) {
    ...
    var renderHeader = function (page) {
        return React.createElement(Row, { key: "header-" + page, style: { marginTop: '12mm', marginBottom: '2mm', paddingBottom: 4, borderBottomWidth: 2, borderColor: Colors.LIGHT_GRAY3, } },
        ...
        return React.createElement(Column, null,
            React.createElement(Header, null,
                ...
                React.createElement(View, { style: { flex: 4 } },
                    React.createElement(HeaderCode, null, document.code || t('invoice.new')),
            ...
            React.createElement(Contacts, null,
                React.createElement(View, { style: { flex: 1, borderTopWidth: 2, borderColor: Colors.LIGHT_GRAY3, marginRight: 20, paddingTop: 6 } },
                    ...
                    React.createElement(DefaultTextLabel, null, t('dateDue'))),
                React.createElement(View, { style: { flex: 2, borderTopWidth: 2, borderColor: Colors.LIGHT_GRAY3, marginRight: 20, paddingTop: 6 } },
                    ...
                    React.createElement(DefaultTextValue, null, PatternApp.format.date(document.dueDate))),
...
//# sourceMappingURL=invoice_printer.js.map