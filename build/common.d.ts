...
export declare const deserializeDate: (date?: string | Date) => Date;
export declare const deserializeNumber: (number?: number) => number;
export declare const deserializeString: (string?: string) => string;
